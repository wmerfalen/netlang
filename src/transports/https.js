...
(function (netlang) {
    var Https = /** @class */ (function () {
        ...
        Https.prototype.generateFileName = function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, NodeFs.open(FILE_NAME, "w+")];
                        case 1:
                            file = (_a.fd = _b.sent(),
                                _a);
        ...
        Https.prototype.run = function (host, method, uri) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.generateFileName()];
                                    case 1:
                                        file = _a.sent();
                                        ...
                                        req = NodeHttps.request(this.request, function (res) {
